...
img_dir = BASE_DIR / 'path/to/synthtree/images'

if __name__ == "__main__":
    
    torch.cuda.is_available()
    
    coco_train_filename=str(OUTPUT_DIR / 'train_RGB.json')
    coco_val_filename=str(OUTPUT_DIR / 'val_RGB.json')
    coco_test_filename=str(OUTPUT_DIR / 'test_RGB.json')
    img_dir = str(img_dir)
    ...
    dir_fold_test = os.path.join(cfg.OUTPUT_DIR, "eval_0")
